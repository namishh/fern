...
when ODIN_OS == .Linux do foreign import onnx "libonnxruntime.so"
when ODIN_OS == .Windows do foreign import onnx "onnxruntime.lib"
when ODIN_OS == .Darwin do foreign import onnx "onnxruntime.dylib"
